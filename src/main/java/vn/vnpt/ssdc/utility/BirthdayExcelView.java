...
public class BirthdayExcelView extends AbstractExcelView{
    ...
    protected void buildExcelDocument(Map model, HSSFWorkbook workbook,
        ...
        for (int i=0; i< revenueData.size(); i++){
            ...
            c1.setCellValue(Util.convertASCI_UTF8(birthday.getBusinessUnit()));

            Cell c2 = row.createCell(2);
            c2.setCellStyle(style);
            c2.setCellValue(Util.convertASCI_UTF8(birthday.getCustomerName()));
            ...
            if (birthday.getCustomerSegment() !=null && !birthday.getCustomerSegment().isEmpty()){
                if (birthday.getCustomerSegment().equals("KHUT")){
                    c3.setCellValue(Util.convertASCI_UTF8(birthday.getCustomerSegment()));
                } else {
                    c4.setCellValue(Util.convertASCI_UTF8(birthday.getCustomerSegment()));
                }
            }
            ...
            c7.setCellValue(Util.convertASCI_UTF8(birthday.getManagerName()));
