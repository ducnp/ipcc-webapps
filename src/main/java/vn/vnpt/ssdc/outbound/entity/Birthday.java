package vn.vnpt.ssdc.outbound.entity;
...
//    @GeneratedValue(strategy=GenerationType.AUTO)
    ...
    public Birthday(Object data[]) throws UnsupportedEncodingException {
        this.id = (Long)data[0];
        this.businessUnit = Util.convertUTF8_ASCI((String) data[1]);
        this.customerId = (String) data[2];
        this.customerName = Util.convertUTF8_ASCI((String) data[3]);
        this.contactInfo= (String) data[4];
        this.dateOfBirth = (Integer) data[6];
        this.monthOfBirth = (Integer) data[7];
        this.customerSegment = Util.convertUTF8_ASCI((String) data[8]);
        this.gift = (String) data[10];
        this.managerName = Util.convertUTF8_ASCI((String) data[12]);
