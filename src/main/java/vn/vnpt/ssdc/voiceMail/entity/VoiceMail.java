...
public class VoiceMail {
    ...
    public VoiceMail(String customer_name, String customer_type, String customer_phone,
                    ...
                    String agent_note, String path_file_record,String agent_email) {
    ...
    public String getAgentSeenName() {
        return agentSeenName;
    }

    public void setAgentSeenName(String agentSeenName) {
        this.agentSeenName = agentSeenName;
    }

    public String getAgentSeenTime() {
        return agentSeenTime;
    }

    public void setAgentSeenTime(String agentSeenTime) {
        this.agentSeenTime = agentSeenTime;
    }
}
